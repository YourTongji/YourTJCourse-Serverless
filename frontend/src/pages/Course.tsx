              ...
              >
                ...
                <div className="flex items-center justify-between gap-3">
                  <button
                    ...
                    className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full border text-xs font-extrabold transition-all duration-300 ${
                      review.liked
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border bg-white border-slate-200/70 text-xs font-extrabold text-slate-600 hover:bg-slate-50 hover:border-slate-300 hover:-translate-y-0.5 transition-all duration-300"
                    title="评论长图"
                  >
