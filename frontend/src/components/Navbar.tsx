...
export default function Navbar({ announcementCollapsed, onToggleAnnouncementCollapsed }: NavbarProps) {
  ...
  const navBtnBase = 'w-9 h-9 md:w-10 md:h-10 rounded-xl md:rounded-2xl flex items-center justify-center border bg-white/60 backdrop-blur hover:scale-105 hover:bg-white/80 active:scale-95 transition duration-150'
          ...
          <div className="flex items-center gap-1 md:gap-2 shrink-0">
            ...
            <div className="flex items-center gap-1 md:gap-1.5 shrink-0" data-tour="tour-nav-controls">
              <button
                ...
                title="后退"
              >
                <svg className="w-[18px] h-[18px] md:w-5 md:h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
