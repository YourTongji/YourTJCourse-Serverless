      ...
      <Card className="p-6 md:p-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6">
          <div>
            ...
            <p>社区鼓励大家在写点评的时候各显神通，当然一个理想的点评应该</p>
            <ul>
              <li>
                <strong>饱含事实。</strong>"某课很无聊"不是个好的点评，"某课的老师只会读PPT"还可以。你应该只点评自己上过的课程，而不是道听途说的评价。我们鼓励列举事实，不鼓励情绪宣泄。
              </li>
              <li>
                <strong>全面。</strong>课堂、考核、课下，以及特别的体验。这些维度和故事都涉及会很棒。
              </li>
              <li>
                <strong>清晰。</strong>点评不应滥用缩写、绰号、梗，或者对缺乏背景的读者难以理解的其他用语或者描述方式。
              </li>
            </ul>
          </div>

          <div>
            <h2>选课社区是用来找到"水课"的吗？这是否会伤害教学质量？</h2>
            <p>
